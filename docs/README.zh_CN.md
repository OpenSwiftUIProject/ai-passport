...
本分支包含 [OpenSwiftUI Embedded 展示](../README.zh_CN.md)。
[验证记录](development/engineering/openswiftui-embedded-validation.zh_CN.md)分别说明
框架编译、主机 LVGL 渲染与实机检查。
[最初 Swift 记录](development/engineering/embedded-swift-validation.zh_CN.md)
保留此前工具链和设备备份结果。
